...
Terraform module for deploying a web app to ECS with monitoring and ALB integration
...
A Terraform module which implements a web app on ECS and supporting AWS resources. Forked off of the CloudPosse module [of the same name][upstream].

[upstream]: https://github.com/cloudposse/terraform-aws-ecs-web-app/tree/main
...
```terraform
module "module" {
  source = "git::https://gitlab.com/guardianproject-ops/terraform-aws-ecs-web-app?ref=main"
}
```
...
File a GitLab [issue](https://gitlab.com/guardianproject-ops/terraform-aws-ecs-web-app/-/issues), send us an [email][email] or join our [Matrix Community][matrix].
...
Please use the [issue tracker](https://gitlab.com/guardianproject-ops/terraform-aws-ecs-web-app/-/issues) to report any bugs or file feature requests.
...
Copyright © 2024-2024 [The Guardian Project](https://guardianproject.info)
...
<!-- markdownlint-disable -->
  [website]: https://guardianproject.info/?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-ecs-web-app&utm_content=website
  ...
  [readme_header_link]: https://guardianproject.info?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-ecs-web-app&utm_content=readme_header_link
  [readme_commercial_support_img]: https://www.sr2.uk/readme/paid-support.png
  [readme_commercial_support_link]: https://www.sr2.uk/?utm_source=gitlab&utm_medium=readme&utm_campaign=guardianproject-ops/terraform-aws-ecs-web-app&utm_content=readme_commercial_support_link
